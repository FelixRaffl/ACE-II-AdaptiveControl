...
#ifndef encoder_test_types_h_
#define encoder_test_types_h_
#include "rtwtypes.h"
#include "MW_SVD.h"
...
typedef struct tag_RWocY1aAVmuibq0rYX5t0G codertarget_arduinobase_int_d_T;
